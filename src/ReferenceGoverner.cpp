...
ReferenceGoverner::ReferenceGoverner(ros::NodeHandle& nh, std::shared_ptr<DatabaseConfig> &databaseconfig)
 :  databaseconfig(databaseconfig),
    ...
    subscriber = nh.subscribe("ref_values", frequency, &ReferenceGoverner::subscriber_callback, this);
...
std::vector<double> ReferenceGoverner::get_data() const {
  return data;
}
